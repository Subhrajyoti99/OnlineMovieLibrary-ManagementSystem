...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2020 at 06:27 PM
...
(1, 'ave.jpg', 'Avengers Endgame', 'After the devastating events of Avengers: Infinity War (2018), the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos\' actions and rest', 0.0),
...
(10001001, '2015-05-06 08:13:09', '2020-04-16 08:13:09', 2, 'confirmed'),
(10001002, '2015-05-06 08:17:15', '2020-07-09 08:17:15', 3, 'unpaid');
...
(11111155, 'Upside Down', 'i love this movie', '11111155.png', 'single', 2013, 5.0, '2020-01-06 12:39:01', 0, 2222222255),
(11111158, 'Baby Driver', 'After being coerced into working for a crime boss, a young getaway driver finds himself taking part in a heist doomed to fail.', '11111158.jpg', 'single', 2017, 3.4, '2020-01-15 07:19:15', 0, 2222222255),
(11111159, 'The Shawshank Redemption', 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency', '11111159.jpg', 'single', 1994, 2.0, '2020-01-15 07:58:00', 0, 2222222255),
(11111160, 'The Godfather', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son. ', '11111160.jpg', 'single', 1972, 3.0, '2020-01-15 07:59:27', 0, 2222222255),
(11111161, 'The Dark Knight', 'When the menace known as the Joker emerges from his mysterious past, he wreaks havoc and chaos on the people of Gotham, the Dark Knight must accept one of the greatest psychological and physical tests', '11111161.jpg', 'single', 2008, 3.0, '2020-01-15 08:00:48', 0, 2222222255),
(11111162, '12 Angry Men ', 'A jury holdout attempts to prevent a miscarriage of justice by forcing his colleagues to reconsider the evidence. ', '11111162.jpg', 'single', 1957, 5.0, '2020-01-15 13:54:15', 0, 2222222255);
...
(1, ' Nullam interdum metus', 'John Maniy', '2020-01-15', 'm1.jpg', 'single', 11111),
(2, 'badmoms', 'abcd', '2020-01-15', 'm2.jpg', 'single', 22222),
(4, 'jason Bourne', 'David', '2020-01-15', 'm5.jpg', 'single', 44444),
(5, 'X-men', 'Steve', '2020-01-15', 'm11.jpg', 'single', 55555);
...
(11, 1, 8, 30, '2019-06-23 14:10:27', '2020-01-15 16:04:24', 1);
...
(294, 11111161, 4.5, 1),
(295, 11111162, 4.5, 1),
(296, 11111159, 2.6, 2222222282),
(297, 11111161, 3.5, 2222222282),
(298, 11111155, 1.4, 2222222282);
...
(1, 'Citizen Soldier', '2020-01-15', 4.3, 'm13.jpg', 'single'),
(2, 'X-Men', '2020-01-15', 4.0, 'm11.jpg', 'single'),
(3, 'Greater', '2020-01-15', 3.0, 'm12.jpg', 'single'),
(4, 'Light B/t Oceans', '2020-01-15', 3.5, 'm7.jpg', 'single'),
(5, 'The BFG', '2020-01-15', 4.5, 'm8.jpg', 'single'),
(6, 'Central Intelligence', '2020-01-15', 4.0, 'm9.jpg', 'single'),
(7, 'Don\'t Think Twice', '2020-01-15', 3.0, 'm10.jpg', 'single'),
(8, 'Peter', '2020-01-15', 5.0, 'm17.jpg', 'single'),
(9, 'God’s Compass', '2020-01-15', 3.5, 'm15.jpg', 'single');
...
(17, 'subhrajyoti.mark@gmail.com', '5GSPngymrQXC23UNVos9'),
(18, 'papai@gmail.com', 'VODdXpxA0jvgkRxpQOnp'),
(19, 'baba@gmail.com', 'pnhQStLuj0nCtSrHlMGj'),
(20, 'subhrajyoti.mark@gmail.com', 'uImYKr8drmPHIH1mWBHp'),
(21, 'subhrajyoti.mark@gmail.com', 'w2S3SmN7LFAjusPZhAUK'),
(22, 'subhrajyoti.mark@outlook.com', 'QDulm7U980Nh3IsZovPj'),
(23, 'subhrajyoti.mark@gmail.com', 'pHqBNC0zVcgU5xSq6eq3'),
(24, 'subhrajoti.mark@outlook.com', 'UEqE3cIJERxEaBgHOYAP'),
(25, 'papai@gmail.com', 'PEiX7GYktRvU1jFGtSdW'),
(26, 'subhrajyoti.mark@gmail.com', 'VaWNOpYIIn8KfXwjAe3h'),
(27, 'samantasoumyajyoti501@gmail.com', 'wNr4WVhCYiJn6Xpm3iux'),
(28, 'subhrajyoti.mark@gmail.com', 'bn2Hko3a3LgFRRZqdnGW'),
(29, 'subhrajyoti.mark@gmail.com', '24b4ApvU24ORTjYUyksN'),
(30, 'subhrajyoti.mark@gmail.com', 'IoiVhTiGkYn9ljPN2VIx'),
(31, 'subhrajyoti.mark@gmail.com', 'srwoEBJRPYznCGKlc12c'),
(32, 'subhrajyoti.mark@gmail.com', '87xxzvkHIvvHu5qR85wm'),
(33, 'subhrajyoti.mark@gmail.com', '6ERlx6ooHCMP4cD3HtI1'),
(34, 'subhrajyoti.mark@gmail.com', '0PQ17Wj9MTWf5KuIHpbo'),
(35, 'subhrajyoti.mark@gmail.com', 'QTFV8O3yO7VrV55ISpli'),
(36, 'subhrajyoti.mark@gmail.com', 'FgP4ZPy97nErumVkMQhq'),
(40, 'subhrajyoti.mark@outlook.com', '0Pk0II4v9jnACGbVutI5'),
(41, 'subhrajyoti.mark@outlook.com', 'A9nsR85xCEaMhTnstetN'),
(42, 'subhrajyoti.mark@outlook.com', 'zxnBpenlA3wFjYP5b4W3');
...
(2222222282, 'subhro', 'b76d9e7647060fbfc2c7b1e96b8f094d', 3, 1, 'subhrajyoti.mark@outlook.com', '2020-01-16 18:39:07', '0000-00-00 00:00:00');
...
--
ALTER TABLE `movieslist`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11111170;
...
--
ALTER TABLE `subcat`
  MODIFY `cid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `users`
  MODIFY `usr_id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2222222283;
COMMIT;
