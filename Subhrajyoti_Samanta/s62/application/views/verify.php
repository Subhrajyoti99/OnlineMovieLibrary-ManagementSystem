                      ...
                      <tr>
                        <td id="email_content" style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;background:#ffffff;">
                          <table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                            <tbody>
                              <tr>
                                <td height="1" colspan="5" style="line-height:1px;"><span style="color:#FFFFFF;display:none !important;font-size:1px;">&nbsp; You're almost ready to get started with Workplace. Please confirm your email, so we know it's really you. &nbsp; &nbsp;  &nbsp;</span></td>
                              </tr>
                              <tr>
                                <td colspan="5" style="">
                                  <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="1" style="padding-left:8px;"><span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:14px;line-height:20px;color:#373a43;">Workplace</span></td>
                                      </tr>
                                      <tr style="">
                                        <td height="8" style="line-height:8px;">&nbsp;</td>
                                      </tr>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td style="font-size:11px;font-family:LucidaGrande,tahoma,verdana,arial,sans-serif;padding-bottom:10px;">
                                                          <center><span class="mb_work_text" style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:20px;line-height:24px;font-weight:normal;color:#FFFFFF;letter-spacing:0.2px;text-shadow:1px 1px 2px rgba(0,0,0,0.19);">Start using Workplace and turn your ideas into action.</span></center>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                          ...
                                                          <center>
                                                            <a href="#"
                                                              ...
                                                              <table border="0" width="200px" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                                                <tbody>
                                                                  <tr>
                                                                      <td style="border-collapse:collapse;border-radius:2px;text-align:center;display:block;border-radius:4px;box-shadow:0 1px 6px rgba(0, 0, 0, 0.08);background:#42B72A;margin:0px 0px 0px 0px;padding:4px 0px 4px 0px;padding:14px 16px 14px 16px;"><a href="localhost/s62/index.php/login/verify/<?php echo $code;?>"
