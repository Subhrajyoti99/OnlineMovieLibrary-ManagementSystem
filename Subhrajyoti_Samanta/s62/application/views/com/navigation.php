				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
								...
								<ul class="dropdown-menu multi-column columns-3">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											...
											<li><a href="<?php echo base_url('index.php/start/horror');?>">Horror</a></li>
							...
							<li><a href="<?php echo base_url('index.php/start/series');?>">tv - series</a></li>
							<li><a href="<?php echo base_url('index.php/start/news');?>">news</a></li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi-column columns-3">
									<li>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="<?php echo base_url('index.php/start/series');?>">Asia</a></li>
							...
							<li><a href="<?php echo base_url('index.php/start/shortcodes');?>">Short Codes</a></li>
