...
$config['smtp_user'] = "panel3756@gmail.com"; 
$config['smtp_pass'] = "8777317a"; 
...
$ci->email->from('panel3756@gmail.com', 'Confirmation');
$ci->email->to($this->input->post('Email'));
$ci->email->subject('confirmation mail');
